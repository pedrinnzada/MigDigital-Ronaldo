...
window.addEventListener('scroll',()=>{
  ...
  // ─── Attendants data ─────────────────────────
  const attendants = [
    { name: 'David Thiago', role: 'Consultor de Crédito', whatsapp: '5531984783993' },
    { name: 'Carla', role: 'Consultora de Crédito', whatsapp: '5531984783993' },
    { name: 'Ronaldo', role: 'Consultor de Crédito', whatsapp: '5531984783993' },
    { name: 'Leonardo', role: 'Consultor de Crédito', whatsapp: '5531984783993' },
    { name: 'Ana', role: 'Consultora de Crédito', whatsapp: '5531984783993' },
    { name: 'Everton', role: 'Consultor de Crédito', whatsapp: '5531984783993' },
    { name: 'Luiz', role: 'Consultor de Crédito', whatsapp: '5531984783993' }
  ];
...
(function initLoader(){
  ...
  const botResponses = {
    start: {
      text: "Olá! Seja bem-vindo(a) à Mig Digital Empréstimos. Recebemos sua mensagem e em breve o Ronaldo fará seu atendimento.",
      options: [
